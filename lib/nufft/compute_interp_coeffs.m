...
% Adapted from the MATLAB NUFFT algorithm available at 
% http://web.eecs.umich.edu/~fessler/irt/fessler.tgz
%
% Reference:
% [1] J. A. Fessler and B. P. Sutton, Nonuniform Fast Fourier Transforms 
% Using Min-Max Interpolation, IEEE Trans. Image Process., vol. 51, n. 2,
% pp. 560--574, Feb. 2003.
%-------------------------------------------------------------------------%
%%
